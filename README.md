...
[CMake](https://cmake.org) 3.24 or higher is required.The default installation directory is `/usr/local`.  
...
> [!NOTE] 
> Bazel is not yet supported. Please use [cmake](#11-cmake) or [meson](#12-menson) instead.
